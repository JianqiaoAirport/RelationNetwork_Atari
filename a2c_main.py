...
# from stable_baselines.common.policies import CnnPolicy as Policy
from ARNLRF_PV_NET import RNCNNPolicy as Policy
from ARNSRF_PV_NET import RNCNNPolicy as Policy
from CNNLRF_PV_NET import CNNPolicy as Policy
from CNNSRF_PV_NET import CNNPolicy as Policy
# from SASRF_PV_NET import CNNSAPolicy as Policy
...
DATE = '20200227'
ATARI_ENV = 'BreakoutNoFrameskip-v4'
log_dir = "A2C_ARNSRF_Breakout_log_%s/" % DATE

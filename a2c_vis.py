...
class A2C(ActorCriticRLModel):
    """
    The A2C (Advantage Actor Critic) model class, which can visualize the attention scores and relations,
    ...
    def predict(self, observation, state=None, mask=None, deterministic=False):
        ...
        actions, _, states, _, att, mid_relations = self.all_step(observation, state, mask, deterministic=deterministic)
        ...
        return clipped_actions, states, att, mid_relations
